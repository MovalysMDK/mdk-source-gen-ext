...
<xsl:template name="dao-update">
	 ...
	 */
	protected void update<xsl:value-of select="interface/name"/>( <xsl:value-of select="interface/name"/> p_o<xsl:value-of select="interface/name"/>
