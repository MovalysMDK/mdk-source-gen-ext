...
<xsl:template match="visualfield" mode="create-component">
<!-- [component = 'MFTextBox' or component = 'MFIntegerTextField' or component = 'MFDoubleTextField' or component = 'MFSlider'] -->
		<xsl:text>&lt;mf:MFTextBox x:Name="</xsl:text>
