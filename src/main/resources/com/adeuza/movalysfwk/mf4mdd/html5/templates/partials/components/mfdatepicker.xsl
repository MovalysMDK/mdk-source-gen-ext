...
<xsl:template match="HTML-attribute[visualfield/component='MFDatePicker']" mode="partial-component-generation"  priority="1000">
		...
		<xsl:apply-templates select="." mode="call-datepicker">
			...
			<xsl:with-param name="ignoreFormAttribute" select="$ignoreFormAttribute"/>
			<xsl:with-param name="viewModel"><xsl:value-of select="$viewModel"/></xsl:with-param>
		</xsl:apply-templates>
</xsl:template>

<xsl:template match="HTML-attribute" mode="call-datepicker">
	<xsl:param name="readonly-override-value"/>
	<xsl:param name="overide-text"/>
	<xsl:param name="ignoreFormAttribute"/>
	<xsl:param name="viewModel"/>
...
<xsl:template match="HTML-attribute[options/datePickerMode='2']" mode="call-datepicker">
	<xsl:param name="readonly-override-value"/>
	<xsl:param name="overide-text"/>
	<xsl:param name="ignoreFormAttribute"/>
	<xsl:param name="viewModel"/>
