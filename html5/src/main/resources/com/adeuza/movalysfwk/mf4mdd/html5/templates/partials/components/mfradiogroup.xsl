...
<xsl:template match="HTML-attribute[visualfield/component='MFRadioGroup']" mode="partial-component-generation"  priority="1000">
	...
	<xsl:param name="viewModel"/>
		...
		<mf-radiogroup>
			...
			<xsl:attribute name="mf-displayed-attributes">key</xsl:attribute>
		</mf-radiogroup>
