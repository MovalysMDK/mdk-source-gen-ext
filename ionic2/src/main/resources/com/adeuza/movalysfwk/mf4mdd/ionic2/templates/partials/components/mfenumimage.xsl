...
<xsl:template match="HTML-attribute[visualfield/component='MFEnumImage']" mode="partial-component-generation"  priority="1000">
	...
	<xsl:param name="viewModel"/>
		...
		<xsl:comment> Optionnal : the parameters mf-max-width="100px" and mf-max-height="100px" can be added to this component</xsl:comment>
