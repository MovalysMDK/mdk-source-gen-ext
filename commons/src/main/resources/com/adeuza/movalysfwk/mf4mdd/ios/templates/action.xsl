...
<xsl:include href="action/action-savedetail-impl.xsl"/>
<xsl:include href="action/action-deletedetail-impl.xsl"/>

<xsl:template match="master-action">

<xsl:apply-templates select="." mode="file-header">
	<xsl:with-param name="fileName"><xsl:value-of select="action/name"/>.m</xsl:with-param>
</xsl:apply-templates>

<xsl:apply-templates select="." mode="declare-impl-imports"/>

@implementation <xsl:value-of select="action/name"/>

<xsl:call-template name="non-generated-bloc">
	<xsl:with-param name="blocId">synthesize</xsl:with-param>
</xsl:call-template>

NSString *const MFAction_<xsl:value-of select="action/name"/> = @"<xsl:value-of select="action/name"/>";
...
<xsl:apply-templates select="." mode="actionMethods"/>
...
<xsl:template match="master-action" mode="declare-extra-imports">
	<!-- 
