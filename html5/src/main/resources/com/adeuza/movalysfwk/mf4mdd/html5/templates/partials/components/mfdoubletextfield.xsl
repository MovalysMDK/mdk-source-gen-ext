...
<xsl:template match="HTML-attribute[visualfield/component='MFDoubleTextField']" mode="partial-component-generation"  priority="1000">
	...
	<xsl:param name="viewModel"/>
		...
		<xsl:comment> Optionnal : the constrains mf-min, mf-max, mf-integer-min-digits, mf-integer-max-digits, mf-decimal-min-digits and mf-decimal-max-digit can be added to this component</xsl:comment>
		<mf-doublefield>
