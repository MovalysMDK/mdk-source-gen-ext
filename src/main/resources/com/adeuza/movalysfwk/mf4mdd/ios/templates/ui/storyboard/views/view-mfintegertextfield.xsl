...
*****  
***** ENTRY POINT:
*****  	/storyboard/scenes/*scene/controller[@controllerType='LISTVIEW']/sections/*section/subViews/*subView[customClass='MFIntegerTextField']
*****  	or
*****  	/xib-container/components/*component[customClass='MFIntegerTextField']
*****  
****************************************************** -->
...
<xsl:template match="subView[customClass='MFIntegerTextField']|component[customClass='MFIntegerTextField']" mode="subview-outlets-generation"  priority="1000">
	<xsl:comment>subView|component[customClass='MFIntegerTextField']" mode="subview-outlets-generation"</xsl:comment>
