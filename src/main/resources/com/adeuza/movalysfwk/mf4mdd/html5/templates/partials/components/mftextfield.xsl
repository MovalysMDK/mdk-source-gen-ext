...
<xsl:template match="HTML-attribute[visualfield/component='MFTextField']" mode="partial-component-generation"  priority="1000">
		...
		<xsl:comment> Optionnal : the constrains mf-hide-label, mf-css-class-container, mf-custom-format, mf-custom-validation,  mf-password, mf-autocomplete, mf-autocomplete-limit and mf-autocomplete-force can be added to this component</xsl:comment>
