...
<xsl:template match="screen">
	...
	<xsl:apply-templates select="." mode="declare-impl-imports"/>		
		...
		<xsl:choose>
		  <xsl:when test="(workspace = 'true' or multi-panel = 'true') and (./pages/page/chained-delete='true' or ./pages/page/chained-save='true')">
	...
	<!-- <xsl:apply-templates select="layout/buttons/button" mode="method-click-event" /> -->
	...
	<xsl:template name="save-delete-multipanel">
		<xsl:if test="workspace = 'true' or multi-panel = 'true'">
	    	...
	    	<xsl:if test="./pages/page/chained-delete='true'">
	        	...
	        	<xsl:value-of select="viewmodel/name"/><xsl:text>_DeleteItemEvent myevent = new </xsl:text><xsl:value-of select="viewmodel/name"/><xsl:text>_DeleteItemEvent();</xsl:text>
