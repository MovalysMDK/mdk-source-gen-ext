...
<xsl:apply-templates select="." mode="file-header">
	<xsl:with-param name="fileName"><xsl:value-of select="itemCellClassName"/>.m</xsl:with-param>
</xsl:apply-templates>

#import "<xsl:value-of select="itemCellClassName"/>.h"

<xsl:apply-templates select="." mode="declare-impl-imports"/>


<xsl:text>&#13;@interface </xsl:text><xsl:value-of select="itemCellClassName"/>()<xsl:text>&#13;</xsl:text>
...
<xsl:text>&#13;@implementation </xsl:text><xsl:value-of select="itemCellClassName"/> {
<xsl:text>&#13;</xsl:text>
<xsl:call-template name="non-generated-bloc">
