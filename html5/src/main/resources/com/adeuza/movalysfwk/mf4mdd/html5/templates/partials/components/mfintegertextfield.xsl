...
<xsl:template match="HTML-attribute[visualfield/component='MFIntegerTextField']" mode="partial-component-generation"  priority="1000">
	...
	<xsl:param name="viewModel"/>
		...
		<xsl:comment> Optionnal : the constrains mf-min and mf-max can be added to this component</xsl:comment>
