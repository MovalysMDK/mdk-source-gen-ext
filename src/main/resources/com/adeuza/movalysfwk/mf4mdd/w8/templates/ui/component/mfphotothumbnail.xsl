...
<xsl:template match="visualfield[component='MFPhotoThumbnail']" mode="create-component">
		<xsl:text>&lt;mf:MFPhotoThumbnail x:Name="</xsl:text>
		...
		<xsl:text> Value="{Binding Path=</xsl:text>
