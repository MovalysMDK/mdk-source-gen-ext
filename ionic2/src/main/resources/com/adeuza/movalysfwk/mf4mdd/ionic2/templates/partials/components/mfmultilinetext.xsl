...
<xsl:template match="HTML-attribute[visualfield/component='MFMultiLineText']" mode="partial-component-generation"  priority="1000">
		...
		<mf-multilinefield>
			...
			<xsl:attribute name="mf-rows">4</xsl:attribute>
		</mf-multilinefield>
</xsl:template>
