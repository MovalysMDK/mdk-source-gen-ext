...
<xsl:template match="visualfield[component = 'MFRadioEnum']" mode="create-component">

		<xsl:text>&lt;mf:MFRadioEnum x:Name="</xsl:text>
		...
		<xsl:text> mf:RadioEnumTemplate="{StaticResource </xsl:text>
