...
<xsl:template match="subView[customClass='MFPosition']|component[customClass='MFPosition']" mode="subview-runtimeAttributes-generation" priority="1000">
		<xsl:comment>"subView[customClass='MFPosition']" mode="subview-runtimeAttributes-generation"</xsl:comment>
...
<xsl:template match="subView[customClass='MFPosition']|component[customClass='MFPosition']" mode="subview-outlets-generation"  priority="1000">
	<xsl:param name="controllerId"/>
		<xsl:comment>subView|component[customClass='MFPosition']" mode="subview-outlets-generation"</xsl:comment>
