...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/master-viewmodelcreator/viewmodelcreator">
		...
		<xsl:apply-templates
				select="./screens/screen/pages/page/viewmodel/external-lists/external-list/viewmodel[is-screen-viewmodel='false']"
				mode="create-vm" />
		<xsl:apply-templates
				select="./screens/screen/pages/page/viewmodel/external-lists/external-list/viewmodel[is-screen-viewmodel='false']"
				mode="update-vm" />

		<xsl:apply-templates select="./screens/screen/pages/page/viewmodel/subvm/viewmodel[is-screen-viewmodel='false']"
		                     mode="create-vm" />
		<xsl:apply-templates select="./screens/screen/pages/page/viewmodel/subvm/viewmodel[is-screen-viewmodel='false']"
		                     mode="update-vm" />

		<xsl:apply-templates
				select="./screens/screen/pages/page/viewmodel/subvm/viewmodel/subvm/viewmodel[is-screen-viewmodel='false']"
				mode="create-vm" />
		<xsl:apply-templates
